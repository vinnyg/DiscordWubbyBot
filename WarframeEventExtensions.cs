...
namespace WubbyBot.Extensions
{
    public static class WarframeEventExtensions
    {
        ...
        /*public static string DiscordMessage(this WarframeEvent e, bool isNotification)
        {
            dynamic a = e as dynamic;
            return a.DiscordMessage(isNotification);
        }*/
